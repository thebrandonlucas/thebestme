...
describe('Graph Data Converters', () => {
  describe('replaceHabitFrequencyIdsWithText', () => {
    ...
    it('should replace 1 habitId with the corresponding habit text for 3 moods', () => {
      const habitFrequencyHappy = getHabitCountForMoodInTimeRange(
        selectedHabitId,
        daysWithSelectedHabitCount5,
        'Great'
      );
      const habitFrequencyNeutral = getHabitCountForMoodInTimeRange(
        selectedHabitId,
        daysWithSelectedHabitCount5,
        'Okay'
      );
      const habitFrequencySad = getHabitCountForMoodInTimeRange(
        selectedHabitId,
        daysWithSelectedHabitCount5,
        'Not Good'
      );
